  ...
  return (
    <div className="container py-12 space-y-16">
      <section className="text-center space-y-6 pt-12">
        <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold tracking-tight">Document Processing</h1>
        <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
          Welcome back, {user.email}! Upload your documents to begin processing.
        </p>
      </section>
      ...
      <section className="max-w-3xl mx-auto text-center space-y-6 py-8">
        <h2 className="text-2xl font-semibold">Your Processing Dashboard</h2>
